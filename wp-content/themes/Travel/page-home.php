                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <div class="category-img text-center">
                                <a href="listing.html"> <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/hero_category1.png" alt=""></a>
                                <a href="listing.html"> <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/hero_category2.png" alt=""></a>
                                <a href="listing.html"> <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/hero_category3.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/location1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/location2.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Paris</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/location3.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Rome</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/location4.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Italy</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/location5.png" alt="">
                            </div>
                            <div class="location-details">
                                <p>Nepal</p>
            ...
            <div class="container">
                ...
                <div class="directory-active">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/newDirectory1.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/newDirectory2.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/gallery/newDirectory3.png" alt=""></a>
                                <div class="img-text">
                                    <span>$$$</span>
                                    <span>Closed</span>
                                </div>
